...
- (UIView *)samllCircleView
{
    if (!_samllCircleView) {
        ...
        _samllCircleView.backgroundColor = self.mainBackgroudColor?:[UIColor redColor];
...
- (void)setUp
{
    ...
    [self setBackgroundColor:self.mainBackgroudColor?:[UIColor redColor]];
